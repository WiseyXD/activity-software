            ...
            <div className="flex flex-col">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-2">
                    ...
                    <div className="flex-col flex gap-1">
                        ...
                        <p className="font-semibold">{event?.instituteName}</p>
                    </div>
                    <div className="flex-col flex gap-1">
                        <Label className="text-slate-500">
                    ...
                    <div className="flex-col flex gap-1">
                        <Label className="text-slate-500">Achievement :</Label>
                    ...
                    <div className="flex-col flex gap-1">
                        <Label className="text-slate-500">Event Level :</Label>
                        <p className="font-semibold">
                    ...
                    <div className="flex-col flex gap-1">
                        <Label className="text-slate-500">Prize :</Label>
                        <p className="font-semibold">{event?.awardAmount}</p>
                    </div>
                    <div className="flex-col flex gap-1">
                        <Label className="text-slate-500">
                ...
                <h2 className="text-xl mb-1 mt-7">Participant Details</h2>
                <Separator />

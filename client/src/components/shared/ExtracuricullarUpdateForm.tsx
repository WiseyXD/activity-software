...
type ExtracurricularUpdateFormProps = {
    event: IExtracurricularEvent;
    eventId: string;
};

export default function ExtracurricularUpdateForm({
    event,
    eventId,
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            // @ts-ignore
            const { data, isFetching, isError } = await updateExtracuricullar({
                id: eventId,
                credentials: values,
            });
            setIsLoading(false);
